...
window.addEventListener("scroll",(e)=>{
  ...
  // const scrollHe = mBanner_sect.getBoundingClientRect().height;
  ...
  slideText.forEach((txt)=>{
    if (scrollPer >= 151 && scrollPer <= 349){
      const startPo = 0;
      // const slideTextAreaT = document.querySelector("#slide_text").getBoundingClientRect();
      const slideTextAreaH = document.querySelector("#slide_text").clientHeight;
      // console.log(slideTextAreaH)
      const scrollIncre = ((scrollPer - 151)/ slideTextAreaH) * 150;
      // console.log(scrollIncre)
    ...
    // if(scrollPer >= 1000){
    //   brandShop.style.opacity = 0.1;
    //   ftBg.style.display = "block";
    // }else{
    //   brandShop.style.opacity = 1;
    //   ftBg.style.display = "none";
    // }
    ...
    // console.log(fullGageArea);

    // --- fullGage 종료 --- //
})
  // --- main_banner js 종료 --- //
  // console.log(shadowAll)
  var swiper;
